...
Longer-form design decisions and research (Android rendering, lightweight HTML renderers,
MDX URL scheme conventions, etc.) live in [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md).
